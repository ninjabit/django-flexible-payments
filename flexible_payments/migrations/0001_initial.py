# Generated by Django 2.2.1 on 2019-05-10 15:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('initial', 'Initial'), ('pending', 'Pending'), ('settling', 'Settling'), ('settled', 'Settled'), ('failed', 'Failed'), ('canceled', 'Canceled'), ('refunded', 'Refunded')], default='initial', max_length=50)),
                ('data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='flexible_payments.PaymentMethod')),
            ],
            options={
                'abstract': False,
            },
